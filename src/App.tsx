    ...
    <div className="bg-background text-on-surface overflow-x-hidden" style={{ fontFamily: "'Plus Jakarta Sans', sans-serif" }}>
      ...
      <nav className="fixed top-4 left-4 right-4 z-50 max-w-7xl mx-auto flex items-center justify-between px-8 h-16 rounded-2xl bg-neutral-950/80 backdrop-blur-xl shadow-[0_8px_32px_0_rgba(0,0,0,0.8)]">
        <div className="flex items-center gap-8">
          ...
          <div className="hidden md:flex gap-6 items-center text-sm font-medium tracking-tight">
            <a className="text-white border-b-2 border-violet-400 pb-1" href="#">Trade</a>
            <a className="text-neutral-400 hover:text-white transition-colors" href="#">Assets</a>
            <a className="text-neutral-400 hover:text-white transition-colors" href="#">Staking</a>
      ...
      <section className="relative min-h-screen flex flex-col items-center justify-center text-center px-6 pt-20 overflow-hidden">
        ...
        <div className="relative z-10 max-w-4xl">
          ...
          <p className="text-lg md:text-xl max-w-2xl mx-auto mb-10 leading-relaxed" style={{ color: '#adaaaa' }}>
        ...
        <div className="absolute bottom-10 left-1/2 -translate-x-1/2 flex flex-col items-center gap-2 opacity-30">
          <span className="text-[10px] tracking-[0.3em] font-bold">SCROLL TO DISCOVER</span>
          <div className="w-px h-12" style={{ background: 'linear-gradient(to bottom, #bd9dff, transparent)' }} />
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto px-6 grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          <div className="flex flex-col justify-center">
            ...
            <h3 className="text-4xl md:text-5xl font-extrabold mb-8 leading-tight">
              PIX Instantâneo. <br />
              <span style={{ color: '#adaaaa' }}>Sem Atrito.</span>
            </h3>
            <p className="text-lg mb-10 leading-relaxed" style={{ color: '#adaaaa' }}>
          ...
          <div className="glass-panel p-8 rounded-[2rem] hover:-translate-y-2 transition-all duration-500">
            <div className="flex justify-between items-start mb-8">
              ...
              <div className="text-right">
                <p className="text-[10px] font-bold uppercase tracking-tighter" style={{ color: '#adaaaa' }}>Total Balance</p>
                <p className="text-xl font-bold">$42,920.00</p>
              </div>
            </div>
            ...
            <div className="mt-8 pt-6 border-t border-white/5 flex items-center justify-between">
              <span className="text-xs font-medium">Multi-chain Active</span>
            ...
            <div className="space-y-2">
              <div className="p-4 rounded-2xl border border-white/5" style={{ background: 'rgba(38,38,38,0.5)' }}>
                <div className="flex justify-between items-center mb-1">
                  <span className="text-[10px] font-bold uppercase" style={{ color: '#adaaaa' }}>Sell</span>
                  <span className="text-[10px] font-bold" style={{ color: '#adaaaa' }}>Balance: 1.24 BTC</span>
                </div>
                <div className="flex justify-between items-center">
                  <input className="bg-transparent border-none p-0 text-xl font-bold w-1/2 outline-none" type="text" defaultValue="0.5" style={{ color: '#ffffff' }} />
              ...
              <div className="p-4 rounded-2xl border border-white/5" style={{ background: 'rgba(38,38,38,0.5)' }}>
                <div className="flex justify-between items-center mb-1">
                  <span className="text-[10px] font-bold uppercase" style={{ color: '#adaaaa' }}>Buy</span>
                </div>
                <div className="flex justify-between items-center">
                  <input className="bg-transparent border-none p-0 text-xl font-bold w-1/2 outline-none" type="text" defaultValue="32,450.00" style={{ color: '#ffffff' }} />
                  <div className="flex items-center gap-2 px-3 py-1 rounded-full border border-white/10 cursor-pointer" style={{ background: 'rgba(0,0,0,0.4)' }}>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8 text-center">
            {[
              ...
              <div key={label}>
                ...
                <p className="text-xs font-bold uppercase tracking-widest mt-1" style={{ color: '#adaaaa' }}>{label}</p>
              </div>
            ))}
          </div>
        </div>
      ...
      {/* ── Footer ── */}
      <footer className="w-full px-8 flex flex-col md:flex-row justify-between items-center gap-6 pt-20 pb-10 border-t border-white/5" style={{ background: '#000000' }}>
        <div className="flex flex-col gap-4 text-center md:text-left">
          <div className="text-lg font-bold opacity-50 tracking-tighter">Bandex</div>
          <p className="text-xs text-neutral-500">© 2024 Bandex Protocol. Built in the Void.</p>
        </div>
        <div className="flex gap-8 text-xs text-neutral-500">
          {['Documentation', 'Risk Disclosure', 'Privacy', 'Support'].map(link => (
            <a key={link} className="hover:text-neutral-300 transition-colors" href="#">{link}</a>
          ))}
        </div>
        <div className="flex gap-4">
          {['public', 'send', 'groups'].map(icon => (
            <div key={icon} className="w-8 h-8 rounded-full border border-white/10 flex items-center justify-center opacity-70 hover:opacity-100 transition-all cursor-pointer">
